...
const BLOG = {
  ...
  APPEARANCE: process.env.NOTION_BLOG_APPEARANCE || 'light', // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  ...
  CONTACT_EMAIL: process.env.NOTION_BLOG_EMAIL || '',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
  ...
  // 无关紧要的配置
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'A BLOG', // 站点标题 ，被notion中的页面标题覆盖
  AVATAR: '', // 个人头像 默认取public目录下的avatar.png
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'A blog of a man', // 站点描述，被notion中的页面描述覆盖
